...
const Hero = () => {
  ...
  const two = <h2 className="big-heading">Jordanne Alexie M. Bartolome.</h2>;
  const three = <h3 className="big-heading">I make things run.</h3>;
  const four = (
    <>
      <p>
  ...
  const five = (
    <a
      ...
      href="mailto:jordannebartolome@gmail.com"
      target="_blank"
      rel="noreferrer">
      Get in touch!
    </a>
